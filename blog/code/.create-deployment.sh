...
GCP_PERSISTENT_DISK_NAME=`cat ${CURR_DIR}/.config/.GCP_PERSISTENT_DISK_NAME`;
GCP_PERSISTENT_DISK_SIZE=`cat ${CURR_DIR}/.config/.GCP_PERSISTENT_DISK_SIZE`;
...
cat ${CURR_DIR}/persistent-volume.yaml \
  | egrep "^[^\#]" \
  | sed -e "s|\${GCP_PERSISTENT_DISK_NAME}|${GCP_PERSISTENT_DISK_NAME}|g" \
  | sed -e "s|\${GCP_PERSISTENT_DISK_SIZE}|${GCP_PERSISTENT_DISK_SIZE}|g" \
